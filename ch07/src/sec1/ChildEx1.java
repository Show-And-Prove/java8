...
public class ChildEx1 {
	...
	public static void main(String[] args) {
		...
		//자식 클래스는 부모 요소를 모두 활용할 수 있지만, 부모 클래스는 자식 클래스에만 있는 요소를 활용할수있다.
		Parent c2 = new Parent();
		c2.field1 = 100;
		c2.field2 = "lee";
		//c2.field3 = 200;	field3은 자식클래스에 있는것이므로 부모가 사용할 수 없다.
		
		//부모클래스로 부터 유도된 객체는 부모의 생성자 또는 자식의 생성자를 활용하여 객체를 생성할 수 있다.
		Parent c3;
		c3 = new Parent();
		c3.method1();
